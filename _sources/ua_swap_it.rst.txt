...
**Important Note**: The open62541 server template includes the Common Information Model, however if additional custom information models are required, they must be loaded into the server before invoking
